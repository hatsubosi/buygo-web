...
export class UserOrderDetailComponent {
  ...
  constructor() {
      ...
      if (o) {
        ...
        if (o.paymentInfo) {
          ...
          if (o.paymentInfo.paidAt) {
            ...
            try {
              const date = (o.paymentInfo.paidAt as any).toDate
                ? (o.paymentInfo.paidAt as any).toDate()
                : new Date(o.paymentInfo.paidAt as any);
    ...
    effect(() => {
      if (
        this.groupBuyService.updatingOrder() === false &&
        !this.groupBuyService.updateOrderError()
      ) {
        // Success - close forms
