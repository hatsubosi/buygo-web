  ...
  template: `
    <div class="min-h-screen pt-8 pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <app-ui-container customClass="p-8">
        ...
        @if (showForm()) {
          <div
            class="mb-8 rounded-xl border border-white/10 bg-white/5 p-6 animate-in slide-in-from-top-4 fade-in"
          >
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <button
                    type="button"
                    (click)="addSpec()"
                    class="mt-2 text-sm text-blue-400 hover:text-blue-300 flex items-center"
                  >
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          @if (products().length === 0) {
            <div class="col-span-full py-12 text-center text-gray-500">No products added yet.</div>
          }
        </div>
      </app-ui-container>
    </div>
...
export class ManagerProductListComponent {
  ...
  constructor() {
    ...
    effect(
      () => {
        if (
          !this.groupBuyService.isActionLoading() &&
          !this.groupBuyService.actionError() &&
          this.showForm() &&
          this.submitted
        ) {
