import { Component, inject, OnInit, effect, signal, computed, ViewChild , ChangeDetectionStrategy } from '@angular/core';
                                    ...
                                    <tr class="hover:bg-white/5 transition-colors">
                                        ...
                                        <td class="p-4">
                                            ...
                                            @if (isReadyToShip(order)) {
                                                <div class="mt-1 text-xs text-green-400 font-bold border border-green-500/30 bg-green-500/10 px-1 py-0.5 rounded inline-block">
                                                    READY TO SHIP
                                                </div>
                                            }
                                            @if (isFullyShipped(order)) {
                                                <div class="mt-1 text-xs text-gray-400 font-bold border border-gray-500/30 bg-gray-500/10 px-1 py-0.5 rounded inline-block">
                                                    SHIPPED
                                                </div>
                                            }
                                        </td>
