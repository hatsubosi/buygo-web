      ...
      <app-ui-container>
        <div class="p-12 text-center">
          <div class="mb-6 flex justify-center">
            <div
              class="h-20 w-20 rounded-full bg-green-500/20 flex items-center justify-center text-green-400"
            >
              <svg
          ...
          <p class="text-gray-400 mb-8">
            Thank you for your order. Your order ID is <br /><span
              class="font-mono text-blue-400"
              >{{ orderId }}</span
            >
          </p>
          <div
            class="bg-blue-500/10 border border-blue-500/20 p-4 rounded-lg mb-8 max-w-lg mx-auto"
          >
            <p class="text-blue-200 text-sm">
              <strong>Reminder:</strong> After completing your payment, please go to the Order
              Details page to update your payment information (Method, Amount, Date).
            </p>
          </div>
          ...
          <div class="flex justify-center gap-4">
            ...
            <app-ui-btn variant="primary" (onClick)="backToProject()"> Back to Project </app-ui-btn>
          </div>
        </div>
      </app-ui-container>
    </div>
