import { Component, inject, OnInit, effect, computed, signal, ViewChild, ChangeDetectionStrategy } from '@angular/core';
...
import { RegisterItem, Registration, EventItem, RegistrationStatus } from '../../../core/api/api/v1/event_pb';

@Component({
    selector: 'app-event-detail',
    imports: [UiContainerComponent, UiBtnComponent, DatePipe, FormsModule, RouterLink, UiDialogComponent],
...
export class EventDetailComponent implements OnInit {
    ...
    async submitRegistration() {
        ...
        const items = Object.entries(this.itemQuantities()).map(([id, qty]) => new RegisterItem({
            eventItemId: id,
            quantity: qty
        }));
    ...
    getStatusLabel(status: RegistrationStatus): string {
        switch (status) {
            ...
            case RegistrationStatus.UNSPECIFIED: return 'Unspecified';
