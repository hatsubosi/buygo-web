  ...
  template: `
    <div class="relative overflow-hidden">
      ...
      <div class="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div
          class="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-blue-600/20 blur-[120px]"
        ></div>
        <div
          class="absolute top-[20%] -right-[10%] w-[40%] h-[40%] rounded-full bg-purple-600/20 blur-[120px]"
        ></div>
        <div
          class="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#0a0a0a] to-transparent z-10"
        ></div>

        <div class="relative z-20 container mx-auto px-4 text-center">
          <div
            class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-8 animate-fade-in-up"
          >
          ...
          <h1
            class="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent animate-fade-in-up delay-100"
          >
            Smart Shopping <br />
          ...
          <p class="text-xl text-gray-400 mb-10 max-w-2xl mx-auto animate-fade-in-up delay-200">
            Join exclusive group buys, unlock tier-based discounts, and participate in community
            events.
          </p>
      ...
      <div class="container mx-auto px-4 pt-24 pb-24 relative z-20">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <!-- Card 1 -->
          <app-ui-container
            customClass="h-full p-8 hover:scale-105 transition-transform duration-300"
          >
            ...
            <p class="text-gray-400">
              Join forces with others to unlock wholesale prices. The more people join, the lower
              the price drops.
            </p>
          </app-ui-container>
          ...
          >
            <div
              class="h-12 w-12 rounded-xl bg-purple-500/20 flex items-center justify-center mb-6"
            >
            ...
            <p class="text-gray-400">
              Participate in exclusive launch parties and meetups. Connect with creators and
              verified sellers.
            </p>
          </app-ui-container>
          ...
          >
            ...
            <p class="text-gray-400">
              Shop with confidence. All projects are vetted and managed by verified creators with
