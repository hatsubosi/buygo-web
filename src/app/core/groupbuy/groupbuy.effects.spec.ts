...
describe('GroupBuyEffects', () => {
  ...
  describe('loadGroupBuys$', () => {
    ...
    it('should dispatch loadGroupBuysFailure on error', async () => {
      ...
      vi.spyOn((effects as any).client, 'listGroupBuys').mockRejectedValue(
    ...
    it('should fetch all pages using nextPageToken', async () => {
      setupEffect(of(GroupBuyActions.loadGroupBuys()));
      const page1 = [new GroupBuy({ id: '1', title: 'GB1' })];
      const page2 = [new GroupBuy({ id: '2', title: 'GB2' })];

      const clientSpy = vi
        .spyOn((effects as any).client, 'listGroupBuys')
        .mockResolvedValueOnce({ groupBuys: page1, nextPageToken: '100' })
        .mockResolvedValueOnce({ groupBuys: page2, nextPageToken: '' });

      const result = await firstValueFrom(effects.loadGroupBuys$);

      expect(clientSpy).toHaveBeenCalledTimes(2);
      expect(result).toEqual(
        GroupBuyActions.loadGroupBuysSuccess({ groupBuys: [...page1, ...page2] }),
      );
    });
  });
  ...
  describe('loadGroupBuyDetail$', () => {
    ...
    it('should dispatch loadGroupBuyDetailFailure when groupBuy is null', async () => {
      ...
      vi.spyOn((effects as any).client, 'getGroupBuy').mockResolvedValue({
        groupBuy: null,
        products: [],
      });
      ...
      const result = await firstValueFrom(effects.loadGroupBuyDetail$);
      expect(result).toEqual(
        GroupBuyActions.loadGroupBuyDetailFailure({ error: 'Project not found' }),
      );
    });
  ...
  describe('submitOrder$', () => {
    it('should dispatch submitOrderSuccess and send cart items to API', async () => {
      ...
      const createOrderSpy = vi
        .spyOn((effects as any).client, 'createOrder')
        .mockResolvedValue({ orderId: 'ord-1' });
  ...
  describe('createGroupBuy$', () => {
    ...
    it('should dispatch createGroupBuyFailure when no groupBuy returned', async () => {
      ...
      const result = await firstValueFrom(effects.createGroupBuy$);
      expect(result).toEqual(
        GroupBuyActions.createGroupBuyFailure({ error: 'No project returned' }),
      );
    });
    ...
    it('should dispatch createGroupBuyFailure on error', async () => {
      ...
      vi.spyOn((effects as any).client, 'createGroupBuy').mockRejectedValue(
  ...
  describe('updateGroupBuy$', () => {
    ...
    it('should dispatch updateGroupBuyFailure when no groupBuy returned', async () => {
      ...
      const result = await firstValueFrom(effects.updateGroupBuy$);
      expect(result).toEqual(
        GroupBuyActions.updateGroupBuyFailure({ error: 'No project returned' }),
      );
    });
    ...
    it('should dispatch updateGroupBuyFailure on error', async () => {
      ...
      vi.spyOn((effects as any).client, 'updateGroupBuy').mockRejectedValue(
  ...
  describe('updateUserOrder$', () => {
    it('should dispatch updateUserOrderSuccess on success', async () => {
      ...
      const updateOrderSpy = vi
        .spyOn((effects as any).client, 'updateOrder')
    ...
    it('should dispatch updateUserOrderFailure when no order returned', async () => {
      ...
      const result = await firstValueFrom(effects.updateUserOrder$);
      expect(result).toEqual(
        GroupBuyActions.updateUserOrderFailure({ error: 'No order returned' }),
      );
    });
  ...
  describe('updatePaymentInfo$', () => {
    it('should dispatch updatePaymentInfoSuccess on success', async () => {
      ...
      setupEffect(
        of(
          GroupBuyActions.updatePaymentInfo({
            orderId: 'o1',
      ...
      const spy = vi
        .spyOn((effects as any).client, 'updatePaymentInfo')
        .mockResolvedValue({ order });
    ...
    it('should dispatch updatePaymentInfoFailure when no order returned', async () => {
      ...
      const result = await firstValueFrom(effects.updatePaymentInfo$);
      expect(result).toEqual(
        GroupBuyActions.updatePaymentInfoFailure({ error: 'No order returned' }),
      );
    });
    ...
    it('should dispatch updatePaymentInfoFailure on error', async () => {
      ...
      vi.spyOn((effects as any).client, 'updatePaymentInfo').mockRejectedValue(
        new Error('pay err'),
      );
