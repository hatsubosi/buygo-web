...
export const selectGroupBuysLoading = createSelector(
  selectGroupBuyState,
  (state) => state.loadingList,
);
export const selectGroupBuysError = createSelector(selectGroupBuyState, (state) => state.listError);

export const selectSelectedGroupBuyId = createSelector(
  selectGroupBuyState,
  (state) => state.selectedGroupBuyId,
);
...
export const selectGroupBuyDetailLoading = createSelector(
  selectGroupBuyState,
  (state) => state.loadingDetail,
);

export const selectCurrentGroupBuyProducts = createSelector(
  selectGroupBuyState,
  (state) => state.currentGroupBuyProducts,
);
...
export const selectIsSubmittingOrder = createSelector(
  selectGroupBuyState,
  (state) => state.submittingOrder,
);
export const selectSubmitOrderError = createSelector(
  selectGroupBuyState,
  (state) => state.submitOrderError,
);
...
export const selectLoadingMyOrders = createSelector(
  selectGroupBuyState,
  (state) => state.loadingMyOrders,
);
export const selectMyOrdersError = createSelector(
  selectGroupBuyState,
  (state) => state.myOrdersError,
);

export const selectUpdatingOrder = createSelector(
  selectGroupBuyState,
  (state) => state.updatingOrder,
);
export const selectUpdateOrderError = createSelector(
  selectGroupBuyState,
  (state) => state.updateOrderError,
);
