      ...
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div class="col-span-1 md:col-span-2">
            ...
            <p class="text-gray-400 max-w-sm">
              Smart shopping together. Join exclusive group buys, unlock tier-based discounts, and participate in community events.
            </p>
          </div>
        ...
        <div class="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-6">
             <!-- Socials (Mock) -->
             <a href="#" class="text-gray-500 hover:text-white transition-colors"><span class="material-icons text-xl">facebook</span></a>
             <a href="#" class="text-gray-500 hover:text-white transition-colors"><span class="material-icons text-xl">thumb_up</span></a>
             <a href="#" class="text-gray-500 hover:text-white transition-colors"><span class="material-icons text-xl">share</span></a>
          </div>
        </div>
      </div>
    </footer>
