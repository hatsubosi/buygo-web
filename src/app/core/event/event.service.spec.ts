...
describe('EventService', () => {
    ...
    describe('Data Loading', () => {
        it('should load events and update signal', async () => {
            ...
            const clientSpy = vi.spyOn((service as any).client, 'listEvents').mockResolvedValue({ events: mockEvents });
        ...
        it('should load single event', async () => {
            ...
            const clientSpy = vi.spyOn((service as any).client, 'getEvent').mockResolvedValue({ event: mockEvent });
    ...
    describe('Mutations', () => {
        it('should create event and update list', async () => {
            ...
            const clientSpy = vi.spyOn((service as any).client, 'createEvent').mockResolvedValue({ event: mockEvent });
