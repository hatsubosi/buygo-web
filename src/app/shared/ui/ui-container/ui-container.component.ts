...
@Component({
  ...
  template: `
    ...
    >
      ...
      <div
        class="pointer-events-none absolute -top-24 -left-24 h-48 w-48 rounded-full bg-blue-500/20 blur-3xl"
      ></div>
      <div
        class="pointer-events-none absolute -bottom-24 -right-24 h-48 w-48 rounded-full bg-purple-500/20 blur-3xl"
      ></div>
    </div>
  `,
  styles: [],
