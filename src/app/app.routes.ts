...
export const routes: Routes = [
    { path: 'login', component: LoginComponent },
    {
        ...
        children: [
            ...
            { path: 'groupbuy/:id/checkout', component: GroupBuyCheckoutComponent, canActivate: [authGuard] },
            { path: 'groupbuy/:id/order-confirmation/:orderId', loadComponent: () => import('./features/groupbuy/order-confirmation/order-confirmation.component').then(m => m.OrderConfirmationComponent), canActivate: [authGuard] },
